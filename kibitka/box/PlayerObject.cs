...
namespace kibitka.box
{
    public class PlayerObject : ICloneable
    {
        ...
        public PlayerObject(ulong cGuid, float cXPos, float cYPos, float cZPos, float cRotation, IntPtr cBaseAddress, IntPtr cUnitFieldsAddress, short cType, String cName, byte cRace, byte cClass, byte cGender, uint cCurrentHealth, uint cMaxHealth, uint cCurrentEnergy, uint cMaxEnergy, uint cLevel)
        {
            Guid = cGuid;
            XPos = cXPos;
            YPos = cYPos;
